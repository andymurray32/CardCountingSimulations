...
public class KO implements Player {
    ...
    public KO(int chips, int playerIndex, int minBet) {
        this.chips = chips;
    ...
    public void printPlayer(int chips) {
        ...
        System.out.println("Player " + this.playerIndex() + ": KO" + "\n\tRemaining Chips: " + (net + chips)+ "\n\tLoss or gain:"+ (net)
                +"\n\tMissed Opportunity:"+missedOP+"\n\tTimes betted more than minimum:"+betExtra) ;
    }

    public void printBet() {
        System.out.println("KO- Player:" + this.playerIndex() + " |Bet: " + this.bet+" |Count = " + this.runningCount);
    }
